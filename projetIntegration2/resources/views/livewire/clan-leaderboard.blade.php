<div>
        ...
        <div class="leaderboard-header p-3 mb-3 border rounded d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown ml-2" wire:ignore>
                ...
                <div class="dropdown-menu" aria-labelledby="exportDropdown">
                    <a class="dropdown-item" href="{{ route('export.topMembres', ['clanId' => $selectedClanId]) }}">Export CSV</a>
                    <a class="dropdown-item" href="#" id="exportTopMembresImage">Export Image</a>
                </div>
            </div>
        </div>
        <div class="row">
    ...
    <div id="topAmeliorationContainer">
        <div class="leaderboard-header p-3 mb-3 border rounded d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex align-items-center">
                    <img src="{{ asset('img/ui/trophy.png') }}" alt="Trophy" style="width:30px; height:30px;" class="mr-2">
            ...
            <div class="dropdown ml-2" wire:ignore>
                ...
                <div class="dropdown-menu" aria-labelledby="exportDropdown">
                    <a class="dropdown-item" href="{{ route('export.topAmelioration', ['clanId' => $selectedClanId]) }}">Export CSV</a>
                    <a class="dropdown-item" href="#" id="exportTopAmeliorationImage">Export Image</a>
                </div>
            </div>
        </div>
        <div class="row">
