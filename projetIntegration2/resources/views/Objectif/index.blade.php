...
<div class="container">
    <h1 class="mb-4">{{ __('objectives.list_title') }}</h1>
    
    <div class="d-flex justify-content-between mb-4">
        <a href="{{ route('statistique.index') }}">
            <button type="button" class="bouton me-2">{{ __('objectives.back') }}</button>
        </a>
        <a href="{{ route('objectif.create') }}">
            <button type="button" class="bouton ms-2">{{ __('objectives.add_objective') }}</button>
        </a>
    </div>
    
    <h2 class="mt-4">{{ __('objectives.uncompleted_objectives') }}</h2>
    <ul class="list-group">
    ...
    <h2 class="mt-4">{{ __('objectives.completed_objectives') }}</h2>
    <ul class="list-group">
