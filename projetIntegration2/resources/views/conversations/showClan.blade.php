...
<body>
    ...
    <style>
        ...
        #emoji-picker-container {
            position: absolute;
            bottom: 60px;
            /* Ajuste selon la hauteur de ton champ texte */
            left: 15%;
            background: white;
            border-radius: 8px;
                ...
                <div class="contenuScrollableMembres">
                    <div class="membre">
                        <a href="#">
                            ...
                            <div>
                                <strong>{{ __('chat.admin') }}</strong> - Tommy Jackson
                            </div>
                        </a>
                    </div>
                    <div class="membre">
    ...
    <script>
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#preview-container').html(
                        ...
                        '" alt="' + translations.selectedImagePreview + '" class="preview-img">' +
        ...
        channel.bind('event-group', function(data) {
            ...
            if (data.deleted === true) {
                ...
                <a href="${data.photo}" target="_blank" download class="btn btn-sm btn-primary">
                    ${translations.downloadFile} ${fileName}
                </a>
            </div>`;
                    }
                }
        ...
        $("form").submit(function(e) {
            ...
            $.ajax({
                ...
                ${translations.downloadFile} ${res.fichier.split('/').pop()}
            </a>`;
                    }
                }
        ...
        <div class="messageTotal" id="message-${res.last_id}">
            <div class="message own-message">
                <button class="delete-btn" data-id="${res.last_id}">${translations.deleteBtn}</button>
                <div class="bubble">
