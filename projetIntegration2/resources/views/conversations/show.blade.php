                                            ...
                                            @if ($message->fichier)
                                                                    ...
                                                                    @if ($isImage)
                                                                        <img src="{{ asset($dossier . $message->fichier) }}" alt="Image envoyée"
                                                                            class="message-img">
                                                                    @else
                                                                        <a href="{{ asset($dossier . $message->fichier) }}" target="_blank" class="text-blue-500">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-grow-1">
                        ...
                        <div class="form-group d-flex flex-column w-100">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <button class="btn btn-primary ms-2" id="BoutonSoumettre"
                                    type="submit">{{ __('chat.soumettre') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
