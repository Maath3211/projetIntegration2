                ...
                <div class="form-scrollable-wrapper">
                    <div class="d-flex row justify-content-center">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center">
                                <input type="text" class="inputModification form-control"
                                    value="{{ Auth::user()->prenom }}" placeholder="{{ __('profile.prenom') }}" name="prenom">
                            </div>
                            <div class="conteneurErreur col-md-4 offset-md-6">
                                @error('prenom')
                                <span class="text-danger">{{ $message }}&ensp;</span>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center">
                                <input type="text" class="inputModification form-control"
                                    value="{{ Auth::user()->nom }}" placeholder="{{ __('profile.nom') }}" name="nom">
                            </div>
                            <div class="conteneurErreur col-md-4 offset-md-6">
                                @error('nom')
                                <span class="text-danger">{{ $message }}&ensp;</span>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center">
                                <textarea class="inputModification form-control"
                                    placeholder="{{ __('profile.a_propos_de_vous') }}" name="aPropos" rows="3">{{ Auth::user()->aPropos }}</textarea>
                            </div>
                            <div class="conteneurErreur col-md-4 offset-md-6">
                                @error('aPropos')
                                <span class="text-danger">{{ $message }}&ensp;</span>
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center">
                                <select class="form-select inputModification form-control" name="genre">
                                    ...
                                    <option value="Prefere ne pas dire"
                                        {{ Auth::user()->genre == 'Prefere ne pas dire' ? 'selected' : '' }}>{{ __('auth.pas_indiquer') }}
                                    </option>
                                </select>
                            </div>
                            <div class="conteneurErreur col-md-4 offset-md-6">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 offset-md-2 d-flex align-items-center">
                                <button class="btn btn-save btn-green">{{ __('profile.sauvegarde') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
